...
import Portada from "../landing/portada_la-rueda-del-tiempo-n-0614-el-senor-del-caos_robert-jordan_202111161743.jpg"
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faArrowRight, faArrowLeft } from "@fortawesome/free-solid-svg-icons";
import { useQuote } from "./hooks/useQuote";

export default function Index() {
   const {quotes, quoteIndex, handleNextQuote, handlePreviousQuote, changeQuoteWithCircle}  = useQuote();

   


    return (
       <div className="bg-cover h-screen w-screen grid grid-cols-1 grid-rows-[5rem_auto]" style={{backgroundImage: `url(${BackgroundLanding})`}}>
         <NavBar/>
